...
# Output Directory
OUTDIR=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/mitogenome

# Version of MitoGenome 
V=1

# Assembled fasta contigs/scaffolds to be searched to find mitogenome
FASTA=/lustre/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/blob_fasta/Gfirm_extracted.fa
