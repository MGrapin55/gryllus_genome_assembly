...
OUTDIR=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/ANNOTATION/Braker3/Braker3_Run

# Set up a trap to copy results back even if job crashes or is canceled
trap 'rsync -auv "/scratch/${USER}/Gfirm/run/" "/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/ANNOTATION/Braker3/Braker3_Run"' exit

# Your Organism's species 
SPECIES=Gfirm

# Path to genome assembly
GENOME=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/ANNOTATION/Braker3/Gfirm.chr.final.masked.numt.sorted.renamed.fasta

# Path to Bam File(s)
BAM=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/ANNOTATION/Braker3/RNAseq/BAM
