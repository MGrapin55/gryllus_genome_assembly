...
OUTDIR=/lustre/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/ANNOTATION/RepeatMM/NUMTs

# Your Organism's species 
SPECIES=Gfirm

# Path to genome assembly
GENOME=/lustre/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/ANNOTATION/RepeatMM/Masked/Gfirm.chr.final.fasta.masked

# Path to Mitogenome assembly
MITOGENOME=/lustre/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gfirm/Gfirm_Production/mitogenome/final_mitogenome.fasta
