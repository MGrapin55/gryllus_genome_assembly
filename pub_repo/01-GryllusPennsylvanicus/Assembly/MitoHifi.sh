...
# Output Directory
OUTDIR=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gpenn/Gpenn_Production/mitogenome

# Version of MitoGenome 
V=1

# Assembled fasta contigs/scaffolds to be searched to find mitogenome
FASTA=/lustre/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gpenn/Gpenn_Production/blob_fasta/Gpenn.p.extracted.fa

# Closely releated ancestor mitogenome in Fasta Format (.fasta, .fa, .fna, etc...)
ANCESTOR_FA=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gpenn/FRESH/ASM_FINAL/ANNOTATION/MitoHifi/ancestor_mitogenome/NC_057052.1.fa

# Closely releated ancestor mitogenome in GeneBank Format (.gb)
ANCESTOR_GBK=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gpenn/FRESH/ASM_FINAL/ANNOTATION/MitoHifi/ancestor_mitogenome/MW315773.1.gb
