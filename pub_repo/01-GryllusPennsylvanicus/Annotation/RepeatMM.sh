...
#SBATCH --job-name=Gpenn_RepeatMM
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
# ====================================================================================================== #
WKDIR=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gpenn/FRESH/ASM_FINAL/ANNOTATION/RepeatsMM

FASTA=/work/moorelab/mgrapin2/GRYLLUS_ASSEMBLIES/Gpenn/FRESH/ASM_FINAL/ANNOTATION/Gpenn.ls.v2.nuclear.scaffolds.closed.fa

SPECIES="Gpenn"

# DeepTE 
DEEPTE=/home/moorelab/mgrapin2/GitRepos/DeepTE/DeepTE.py
...
CLEAN=/home/moorelab/mgrapin2/SCRIPTS/HiFi_Pipeline/ANNOTATION/repeatMM_scripts/CleanDeepTEheader.py

# Terl 
TERL=/home/moorelab/mgrapin2/GitRepos/TERL/terl_test.py
MODEL_TERL=/home/moorelab/mgrapin2/SCRIPTS/HiFi_Pipeline/ANNOTATION/repeatMM_scripts/DS3
# wget https://raw.githubusercontent.com/pedronachtigall/Repeat-annotation-pipeline/refs/heads/main/scripts/FilterTERL.py
FILTER=/home/moorelab/mgrapin2/SCRIPTS/HiFi_Pipeline/ANNOTATION/repeatMM_scripts/FilterTERL.py
...
GFF=/home/moorelab/mgrapin2/SCRIPTS/HiFi_Pipeline/ANNOTATION/repeatMM_scripts/AdjustingGFF_RM.py
...
#add a prefix (Fasta is the fasta from the output now, will want to make a new variable name for this)
